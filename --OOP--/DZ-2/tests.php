...
test("<select id='123' name='select'><option value='1'>one</option><option value='2'>two</option><option value='3'>three</option></select>",
...
test("<textarea name='text' id='123' class='text' style='style' coll='30' row='30'>aaa</textarea>",
